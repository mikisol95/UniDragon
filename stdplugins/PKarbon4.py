...
usage: .ikar4 //as a reply to any text message
...
@borg.on(admin_cmd(pattern="ikar4 ?(.*)", allow_sudo=True))
async def carbon_api(e):
 if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
   ...
   await hmm.edit("🌝🌝🌝🌝🌝")
   file = './carbon.png'
   await hmm.edit("✅Karbon4 Completed, Uploading Karbon✅")
   await e.client.send_file(
         e.chat_id,
         file,
         caption="Karbon4 by [@PhycoNinja13b](https://github.com/Phyco-Ninja/UniNinja)",
         force_document=True,
