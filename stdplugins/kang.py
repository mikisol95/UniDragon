...
async def _(event):
    ...
    packname = f"@NeoMatrix90 nikal lawde"
    packshortname = f"bangbros_gengbeng{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packshortname = f"@chutiya_Animated"  # format: Uni_Borg_userid
    ...
    await event.edit("Aaham Brahmassami................")
